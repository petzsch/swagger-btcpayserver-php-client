...
class InvoicesApi
{
    ...
    /**
     * Operation invoicesAddCustomerEmail
     *
     * Add customer email to invoice
     *
     * @param  \Swagger\Client\Model\AddCustomerEmailRequest $body body (required)
     ...
     */
    public function invoicesAddCustomerEmail($body, $store_id, $invoice_id)
    {
        list($response) = $this->invoicesAddCustomerEmailWithHttpInfo($body, $store_id, $invoice_id);
        return $response;
    }

    /**
     * Operation invoicesAddCustomerEmailWithHttpInfo
     *
     * Add customer email to invoice
     *
     * @param  \Swagger\Client\Model\AddCustomerEmailRequest $body (required)
     * @param  string $store_id The store to query (required)
     * @param  string $invoice_id The invoice to update (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function invoicesAddCustomerEmailWithHttpInfo($body, $store_id, $invoice_id)
    {
        $returnType = '\Swagger\Client\Model\InvoiceData';
        $request = $this->invoicesAddCustomerEmailRequest($body, $store_id, $invoice_id);
    ...
    /**
     * Operation invoicesAddCustomerEmailAsync
     *
     * Add customer email to invoice
     *
     * @param  \Swagger\Client\Model\AddCustomerEmailRequest $body (required)
     ...
     */
    public function invoicesAddCustomerEmailAsync($body, $store_id, $invoice_id)
    {
        return $this->invoicesAddCustomerEmailAsyncWithHttpInfo($body, $store_id, $invoice_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation invoicesAddCustomerEmailAsyncWithHttpInfo
     *
     * Add customer email to invoice
     *
     * @param  \Swagger\Client\Model\AddCustomerEmailRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesAddCustomerEmailAsyncWithHttpInfo($body, $store_id, $invoice_id)
    {
        $returnType = '\Swagger\Client\Model\InvoiceData';
        $request = $this->invoicesAddCustomerEmailRequest($body, $store_id, $invoice_id);
    ...
    /**
     * Create request for operation 'invoicesAddCustomerEmail'
     *
     * @param  \Swagger\Client\Model\AddCustomerEmailRequest $body (required)
     * @param  string $store_id The store to query (required)
     * @param  string $invoice_id The invoice to update (required)
     ...
     */
    protected function invoicesAddCustomerEmailRequest($body, $store_id, $invoice_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling invoicesAddCustomerEmail'
            );
        }
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling invoicesAddCustomerEmail'
            );
        }
        // verify the required parameter 'invoice_id' is set
        if ($invoice_id === null || (is_array($invoice_id) && count($invoice_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $invoice_id when calling invoicesAddCustomerEmail'
            );
        }

        $resourcePath = '/api/v1/stores/{storeId}/invoices/{invoiceId}/email';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function invoicesGetInvoices($store_id)
    {
        list($response) = $this->invoicesGetInvoicesWithHttpInfo($store_id);
        return $response;
    }
     ...
     */
    public function invoicesGetInvoicesWithHttpInfo($store_id)
    {
        $returnType = '\Swagger\Client\Model\InvoiceDataList';
        $request = $this->invoicesGetInvoicesRequest($store_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesGetInvoicesAsync($store_id)
    {
        return $this->invoicesGetInvoicesAsyncWithHttpInfo($store_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesGetInvoicesAsyncWithHttpInfo($store_id)
    {
        $returnType = '\Swagger\Client\Model\InvoiceDataList';
        $request = $this->invoicesGetInvoicesRequest($store_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function invoicesGetInvoicesRequest($store_id)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
