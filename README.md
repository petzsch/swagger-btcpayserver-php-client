...
*InvoicesApi* | [**invoicesAddCustomerEmail**](docs/Api/InvoicesApi.md#invoicesaddcustomeremail) | **POST** /api/v1/stores/{storeId}/invoices/{invoiceId}/email | Add customer email to invoice
